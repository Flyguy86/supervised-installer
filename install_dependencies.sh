...
echo "rm /var/lib/dietpi/postboot.d/DockerInstaller.sh" >> /var/lib/dietpi/postboot.d/DockerInstaller.sh
echo "sleep 5; reboot" >> /var/lib/dietpi/postboot.d/DockerInstaller.sh
